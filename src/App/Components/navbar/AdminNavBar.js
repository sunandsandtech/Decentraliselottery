    ...
    <Navbar className="navbar" collapseOnSelect expand="lg">
      ...
      <Navbar.Collapse className="justify-content-end navbarcollapse">
        <Nav>
          ...
          <Nav.Link
            className={`hovernav ${
              window.location.pathname.includes(Path.adminorglist)
                ? "activenav"
                : ""
            }`}
            href={Path.adminorglist}
          >
            Bookies List
          </Nav.Link>
          <Nav.Link
            className={`hovernav ${
              window.location.pathname.includes(Path.adminlotterylist)
                ? "activenav"
                : ""
            }`}
            href={Path.adminlotterylist}
          >
            Lotteries List
          </Nav.Link>
